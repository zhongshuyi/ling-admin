...
public class DataPermissionInterceptor extends JsqlParserSupport implements InnerInterceptor {
    ...
    protected final void processDelete(
            ...
            final String sql,
            final Object obj) {
        final Expression newWhere = dataPermissionHelper.getNewWhere(delete.getWhere(), (String) obj, false);
    ...
    protected final void processUpdate(
            ...
            final String sql,
            final Object obj) {
        final Expression newWhere = dataPermissionHelper.getNewWhere(update.getWhere(), (String) obj, false);
        if (ObjectUtil.isNotEmpty(newWhere)) {
    ...
    private void setWhere(
            ...
            final String obj) {
        final Expression newWhere = dataPermissionHelper.getNewWhere(select.getWhere(), obj, false);
        if (ObjectUtil.isNotEmpty(newWhere)) {
