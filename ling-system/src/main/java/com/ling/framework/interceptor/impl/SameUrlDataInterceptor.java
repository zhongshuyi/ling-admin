package com.ling.framework.interceptor.impl;
...
import com.ling.common.constant.GlobalConstants;
import com.ling.common.filter.RepeatedlyRequestWrapper;
...
public class SameUrlDataInterceptor extends BaseRepeatSubmitInterceptor implements Serializable {
    ...
    public final boolean isRepeatSubmit(
        ...
        nowDataMap.put(SameUrlDataInterceptor.REPEAT_PARAMS, nowParams);
        nowDataMap.put(SameUrlDataInterceptor.REPEAT_TIME, System.currentTimeMillis());
        ...
        // 唯一标识（指定key + 消息头）
        final String cacheRepeatKey = SameUrlDataInterceptor.REPEAT_SUBMIT_KEY + submitKey;
        ...
        RedisUtils.setCacheObject(cacheRepeatKey, cacheMap, Duration.ofMinutes(intervalTime));
        return false;
    }
    ...
    private boolean compareParams(
        ...
        final String nowParams = (String) nowMap.get(SameUrlDataInterceptor.REPEAT_PARAMS);
        final String preParams = (String) preMap.get(SameUrlDataInterceptor.REPEAT_PARAMS);
    ...
    private boolean compareTime(
        ...
        final Long time1 = (Long) nowMap.get(SameUrlDataInterceptor.REPEAT_TIME);
        final Long time2 = (Long) preMap.get(SameUrlDataInterceptor.REPEAT_TIME);
